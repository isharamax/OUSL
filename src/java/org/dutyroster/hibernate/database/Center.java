...
public class Center  implements java.io.Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 17 * hash + (this.centerId != null ? this.centerId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.centerId != other.centerId && (this.centerId == null || !this.centerId.equals(other.centerId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "Center{" + "centerId=" + centerId + ", centerName=" + centerName + '}';
    }
