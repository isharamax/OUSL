...
@Getter@Setter
    private List<PreOrientationStaff> allPres = new ArrayList<PreOrientationStaff>();
@Getter@Setter
private ScheduleModel eventModel;  
    ...
    public void init() {
        ...
        allPres = orientationService.getPreorienatationsForStaffMember(staffMember);
    ...
    public String save() {
        ...
        PreOrientation pre = null;
        try {
            dateAttended = new SimpleDateFormat("y-M-d", Locale.ENGLISH).parse(attendedDate);
            pre = orientationService.getPre(department, attendedProgram, attendedSession, attendedCenter, dateAttended);
            if (currentPreorientation != null) {
                if (pre != null) {
        ...
        if (result) {
            context.addMessage(null, new FacesMessage("Success", "Record Was Successfully Saved and Sent for Approval!"));         
            allPres = orientationService.getPreorienatationsForStaffMember(staffMember);
        } else {
